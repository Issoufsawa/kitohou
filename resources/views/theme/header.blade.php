...
<html lang="en">
    <head>
        ...
        <title>www.KOOPS-BROW.com </title>
        ...
        <nav class="navbar fixed-top navbar-expand-lg">
            <div class="container">
                ...
                <a href="#" class="navbar-brand">
                    <img src="{{asset('/images/logo.jpeg')}}" alt="logo" width="80" height="80"></i>KOOPS & BROWN 
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#section_3">Nos actualités</a>
                        </li>
